...
- Fiancé [Magdalena](https://github.com/madzikdek) for assistance with Python syntax (if "literal" in str(e): in main_menu())
- Fiancé [Magdalena](https://github.com/madzikdek) for the idea of using RegEx to check if save code was entered correctly.
